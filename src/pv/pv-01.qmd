...
ggplot(df, aes(x = coordinate_x_raw, coordinate_y_raw)) +
  ...
  theme_void() +
  theme(
    plot.title = element_text(family = "Courier New", hjust = 0.5, vjust = 5, face = "bold", color = "#1D3557", size = 24),
    plot.subtitle = element_text(family = "Arial",hjust = 0.5, vjust = 10),
    strip.text = element_text(family = "Courier New", face = "bold", size = 14, color = "#1D3557", hjust = 0.5, vjust = 1),
