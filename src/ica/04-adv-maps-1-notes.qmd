...
mn_water <- st_read("./04_adv_maps/data/shp_water_lakes_rivers/LakesAndRivers.shp")
```
...
transform_and_plot(nc, new_crs = "EPSG:26918")
```
...
ggplot() +
    ...
    coord_sf(xlim = seven_counties_sf[c("xmin", "xmax")], ylim = seven_counties_sf[c("ymin", "ymax")]) + # NEW: crop map to Twin Cities bounding box
